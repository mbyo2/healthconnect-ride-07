  ...
  return (
    <section className="py-16 md:py-20 relative overflow-hidden px-4">
      ...
      <div className="container mx-auto relative z-10">
        <div className="bg-gradient-to-r from-blue-600 to-indigo-700 rounded-2xl p-6 md:p-10 lg:p-16 text-center text-white shadow-xl">
          ...
          <div className="flex flex-col sm:flex-row gap-4 justify-center">
            <Button 
              size="lg"
              className="bg-white text-blue-700 hover:bg-blue-50 px-5 py-4 md:px-8 md:py-6 text-base md:text-lg rounded-full shadow-lg hover:shadow-xl transition-all duration-300 w-full sm:w-auto"
