      ...
      <div className="grid grid-cols-1 lg:grid-cols-3 gap-6">
        ...
        <div className={`p-5 rounded-2xl border space-y-4 ${
          ...
          <div className="space-y-3">
            {[
              { name: "Dr. Mutale Mwansa", role: "Chief Cardiologist", status: "In Surgery", avatar: "https://images.unsplash.com/photo-1622253692010-333f2da6031d?w=100&auto=format&fit=crop&q=80" },
              ...
              { name: "Dr. Chisamba Banda", role: "Neurologist", status: "On Duty", avatar: "https://images.unsplash.com/photo-1537368910025-700350fe46c7?w=100&auto=format&fit=crop&q=80" },
              { name: "Dr. Elena Rostova", role: "Pediatric Specialist", status: "In Teleconsult", avatar: "https://images.unsplash.com/photo-1559839734-2b71ea197ec2?w=100&auto=format&fit=crop&q=80" },
            ].map((doc) => (
