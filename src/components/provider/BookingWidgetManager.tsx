...
import { Code2, Copy, ExternalLink, Settings, Palette, Check, Loader2, Globe } from 'lucide-react';
      ...
      <div className="space-y-6">
        <Card>
          <CardHeader>
            ...
            <CardDescription>
              Embed this widget on your website to let patients book directly
            </CardDescription>
          </CardHeader>
          <CardContent>
            <Tabs defaultValue="embed">
              ...
              <TabsContent value="link" className="space-y-4 mt-4">
                ...
                <p className="text-xs text-muted-foreground">
                  Share this link directly with patients or add it to your website's "Book Now" button.
                </p>
              </TabsContent>
              ...
              <TabsContent value="stats" className="mt-4">
                ...
                {widget.allowed_domains && (widget.allowed_domains as string[]).length > 0 && (
                  <div className="mt-4">
                    <p className="text-sm font-medium mb-2">Allowed Domains</p>
                    <div className="flex flex-wrap gap-2">
                      {(widget.allowed_domains as string[]).map(d => (
  ...
  return (
    <Card>
      <CardHeader>
        ...
        <CardDescription>
          Add a booking button to your website so patients can schedule appointments directly
        </CardDescription>
      </CardHeader>
