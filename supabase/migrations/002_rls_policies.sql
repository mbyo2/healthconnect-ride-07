...
-- Run this after 001_advanced_features.sql
...
-- =====================================================
-- DAILY HEALTH METRICS - Users manage their own data
-- =====================================================
...
-- Trigger to update streak on daily health metrics insert
CREATE TRIGGER trigger_update_streak_on_daily_health_metrics
    AFTER INSERT ON public.daily_health_metrics
    FOR EACH ROW
